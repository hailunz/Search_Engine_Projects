			...
			try {
				...
				while(true){
					try {
						...
						// update local clock
						if (revMsg.dupe.equals("false"))
							this.mp.clockser.compareClock(revMsg.timeStamp);
						System.out.println("after the comparion new Msg:"+revMsg.toString());
