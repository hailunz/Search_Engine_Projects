...
print "1: " . formulate_query( "obama family tree", "sd", 0.3, 0.4, 0.3  ) . "\n";
print "5: " . formulate_query( "mitchell college", "sd",  0.3, 0.4, 0.3  ) . "\n";
print "10: " . formulate_query( "cheap internet", "sd",  0.3, 0.4, 0.3  ) . "\n";
print "11: " . formulate_query( "gmat prep classes", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "12: " . formulate_query( "djs", "sd",   0.3, 0.4, 0.3 ) . "\n";
print "15: " . formulate_query( "espn sports", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "17: " . formulate_query( "poker tournaments", "sd", 0.3, 0.4, 0.3 ) . "\n";
print "26: " . formulate_query( "lower heart rate", "sd",   0.3, 0.4, 0.3 ) . "\n";
print "29: " . formulate_query( "ps 2 games", "sd",  0.3, 0.4, 0.3  ) . "\n";
print "30: " . formulate_query( "diabetes education", "sd",  0.3, 0.4, 0.3  ) . "\n";
print "33: " . formulate_query( "elliptical trainer", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "37: " . formulate_query( "pampered chef", "sd",0.3, 0.4, 0.3 ) . "\n";
print "45: " . formulate_query( "solar panels", "sd", 0.3, 0.4, 0.3) . "\n";
print "47: " . formulate_query( "indexed annuity", "sd", 0.3, 0.4, 0.3) . "\n";
print "49: " . formulate_query( "flame designs", "sd", 0.3, 0.4, 0.3 ) . "\n";
print "52: " . formulate_query( "avp", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "71: " . formulate_query( "living in india", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "102: " . formulate_query( "fickle creek farm", "sd",  0.3, 0.4, 0.3 ) . "\n";
print "149: " . formulate_query( "uplift at yellowstone national park", "sd",  0.3, 0.4, 0.3) . "\n";
print "190: " . formulate_query( "brooks brothers clearance", "sd",  0.3, 0.4, 0.3) . "\n";
