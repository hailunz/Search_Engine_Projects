...
print "10: #wand( 1  0 " . formulate_query( "cheap internet", "sd", 0.5, 0.5, 0.5 ) . " ) \n";
print "12: #wand( 1  0 " . formulate_query( "djs", "sd", 0.5, 0.5, 0.5 ) . "\n";
print "26: #wand( 1  0 " . formulate_query( "lower heart rate", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "29: #wand( 1  0 " . formulate_query( "ps 2 games", "sd", 0.5, 0.5, 0.5 ) . "\n";
print "33: #wand( 1  0 " . formulate_query( "elliptical trainer", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "52: #wand( 1  0 " . formulate_query( "avp", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "71: #wand( 1  0 " . formulate_query( "living in india", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "102: #wand( 1  0 " . formulate_query( "fickle creek farm", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "149: #wand( 1  0 " . formulate_query( "uplift at yellowstone national park", "sd", 0.5, 0.5, 0.5 ) . ") \n";
print "190: #wand( 1  0 " . formulate_query( "brooks brothers clearance", "sd", 0.5, 0.5, 0.5 ) . ") \n";
